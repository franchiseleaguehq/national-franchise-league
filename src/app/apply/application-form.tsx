  ...
  return (
    <form onSubmit={submitApplication} className="grid gap-5">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <label className="grid gap-2 text-sm font-bold text-chrome-200">
          Preferred team
          <select name="preferredTeamId" required className="min-h-12 rounded-md border border-white/10 bg-black px-4 text-base text-white outline-none transition focus:border-electric">
      ...
      <label className="flex items-start gap-3 rounded-md border border-white/10 bg-white/[0.05] p-4 text-sm font-semibold leading-6 text-chrome-200">
        <input name="readRules" type="checkbox" required className="mt-1 size-5 accent-electric" />
        I confirm that I read the Rookie Orientation and Official Rulebook.
      </label>
